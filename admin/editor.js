...
const adminSessionStorageKey = "tuval_admin_session";
...
const writeAdminSessionToken = (token = "") => {
  try {
    if (!token) {
...
const login = async () => {
  ...
  writeAdminSessionToken(result.sessionToken || "");
...
const saveToGithub = async () => {
  ...
  const response = await authorizedFetch("../api/content", {
    method: "PUT",
    headers: { "Content-Type": "application/json" },
