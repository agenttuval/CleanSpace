...
const languageTranslations = {
  ...
  hr: {
    ...
    "index.html": [
      ...
      {
        selector: ".hero-content .lead",
        text: "Kompaktni respiratori s aktivnim dovodom filtriranog zraka, bez pojaseva i cijevi, osmišljeni za rad u zahtjevnim okruženjima.",
      },
...
const croatianDynamicReplacements = [
  ...
  ["Kompaktni respiratorji z aktivnim dovajanjem filtriranega", "Kompaktni respiratori s aktivnim dovodom filtriranog"],
  ["zraka, brez pasov in cevi, zasnovani za delo v zahtevnih okoljih.", "zraka, bez pojaseva i cijevi, osmišljeni za rad u zahtjevnim okruženjima."],
  ["Oglej si maske", "Pogledaj maske"],
  ["Povpraševanje", "Upit"],
  ["Ključne prednosti", "Ključne prednosti"],
  ["lahka enota", "lagana jedinica"],
  ["delovanja", "rada"],
  ["Uradni certifikati", "Službeni certifikati"],
  ["Standardi in odobritve", "Standardi i odobrenja"],
  ["Evropski respiratorni standard", "Europski respiratorni standard"],
  ["Zaščita pred prahom in vodo", "Zaštita od prašine i vode"],
  ["Sistem vodenja kakovosti", "Sustav upravljanja kvalitetom"],
  ["Odaberi model", "Odaberi model"],
  ["Odberi model", "Odaberi model"],
  ["Odaberite respirator", "Odaberite respirator"],
  ["Nazaj na maske", "Natrag na maske"],
  ["Kontaktiraj za", "Kontaktiraj za"],
  ...
  ["zaščitno", "zaštitno"],
  ["zaščito", "zaštitu"],
  ["delovna mesta", "radna mjesta"],
  ["delovnim mestom", "radnim mjestima"],
  ...
  ["zahtevna okolja", "zahtjevna okruženja"],
  ["pri delu", "pri radu"],
  ["delo", "rad"],
  ["delu", "radu"],
  ["Uporaba", "Uporaba"],
  ...
  ["aktivnim dovodom", "aktivnim dovodom"],
